...
export default function CardSession() {
  return (
    <div className="mt-[56px] max-w-[1214.833px] mx-auto flex flex-col gap-[25px]">
      <div className="flex items-center gap-[20px]">
        <div >
            <Typography variant="h-xs" font="sans" fontWeight="semibold" color="mine-shaft-950" className="leading-[26.25px]">Explore a wide range of Vendors</Typography>
        </div>
        <div>
