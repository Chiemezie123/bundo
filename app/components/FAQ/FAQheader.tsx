...
export default function FAQheader() {
  return (
    <div className='flex flex-col items-center gap-4'>
        <div className='flex gap-2 mxs:flex-col mxs:items-center mxs:gap-[10px]'>
            <Typography variant="h-xxl" font="sans" fontWeight="bold" color="palm-green-950" className='leading-[75.95px] mlg:text-[3rem]'>Frequently Asked </Typography>
        ...
        <div className='w-[469px] mxs:w-full mxs:text-center'>
